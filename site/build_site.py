...
BUILT   = 'Sunday 26 July 2026, last revised Sunday 2 August 2026'
...
def developments(compact=True):
    """The story in twenty-three turns. `compact` collapses the pre-disaster half
...
<section>
  <p class="eyebrow">How it happened, in twenty-three turns</p>
...
DEV_NOTE = ('<div class="card" style="margin-top:26px">'
            '<p class="eyebrow" style="margin-top:0">The story in twenty-three turns</p>'
