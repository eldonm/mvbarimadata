...
**The number of counts, and a discrepancy that is not reconciled.** The charge is reported as **72 counts of murder in total, laid jointly against the three men — not 72 each** — by Times Caribbean on 28 July and by CMC, Caribbean National Weekly, WIC News and HGPTV on 29 July. No Guyanese outlet reproducing the police or the DPP release states any count, so the figure reached circulation through court reporting and defence comment rather than through an official document. Its derivation appears in one place only: defence attorney Dexter Todd, quoted by Caribbean National Weekly — "the disclosure is that 72 bodies were recovered and so they were charged for all 72 of those deaths." Every official figure since 24 July gives **73** bodies recovered. Both figures are recorded here; nothing in this corpus reconciles them, and this page does not.
...
| First week | Independent safety investigation, separate from any criminal case | Inquiry announced day 7, members named day 8, not yet constituted; charges laid day 10; three candidate statutes named for it and nothing gazetted |
...
What would change this view: the text of Guyana's Shipping Act — including the Part XVIII Ram relies on — and its subsidiary regulations, any record of a casualty investigation conducted under the Code, and the gazetted instrument constituting the commission. The archive holds none of them. Note that Question 1 relies on a secondary description of that Act; the text itself has not been read here.
...
Whether the certificate exists or does not, the same thing follows: the system could not state the vessel's permitted load consistently, and the people responsible gave three different figures in six days. Separately, the load-line finding — even taken entirely at face value — answers a question about draught, not the question about stowage and stability that a survivor account actually raises. The government's own position has since loosened: the regulator's 22 July finding was categorical, and the Prime Minister has since referred the same question to the Commission of Inquiry.
...
The missing death toll does not need a motive to explain it, and this archive does not supply one. What does need explaining is the combination: two decisions that are each defensible alone — do not publish a toll, leave the vessel where it is — produce roughly thirty families with neither a body nor a death certificate, and no stated process for obtaining either. On the counting itself, one long-standing discrepancy is now closed — 77 were rescued and 76 survived, one having died after rescue — and one is newly open: the charge laid on 28 July is reported as 72 counts of murder, where every official figure since 24 July gives 73 bodies recovered.
...
**And one discrepancy on this page's own subject is not resolved.** The three men charged on 28 July face a count reported as **72 counts of murder**, laid jointly. The only published account of what those counts correspond to is defence attorney Dexter Todd's, via Caribbean National Weekly: "the disclosure is that 72 bodies were recovered and so they were charged for all 72 of those deaths." Every official figure since 24 July gives **73** bodies recovered. Both numbers are in the record, no official release states any count at all, and nothing in this corpus reconciles them. This page does not reconcile them either. It is recorded here because a count of the dead that appears in a charge and a count of the dead that appears in a briefing are the two places the state's own arithmetic becomes visible, and they do not agree. The three accused have not been tried and nothing here bears on their guilt or innocence.
